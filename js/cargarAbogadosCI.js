$(document).ready(function(){
	...
	var getdetails = function(ci){
		//return $.getJSON( "http://192.168.1.6/rpa/movil/Service/VAbogados/ListaAbogados/ci/" + ci );
		//return $.getJSON( "http://localhost/rpa/movil/Service/VAbogados/ListaAbogados/ci/"+ci);
		//return $.getJSON( "http://192.168.3.92/rpa/movil/Service/VAbogados/ListaAbogados/ci/"+ci);
		// ID 23 - 25/07/2016 - Cambio de Servicio
		return $.getJSON( "http://rpa.justicia.gob.bo/rpa/movil/Service/VAbogados/ListaAbogados/ci/" + ci );
		//return $.getJSON( "http://www.justicia.gob.bo/rpa/movil/Service/VAbogados/ListaAbogados/ci/" + ci );
	}
